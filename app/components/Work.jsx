...
const Work = () => {
  return (
    ...
    <div className='grid gap-5 my-10 grid-cols-auto'>
    ...
    <a href='' className='flex items-center justify-center gap-2 px-10 py-3 mx-auto my-20 text-gray-700 duration-500 border-[0.5px] border-gray-700 rounded-full w-max hover:bg-lightHover'>
