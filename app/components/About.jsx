      ...
      <motion.div
        ...
        <motion.div
          ...
          <motion.h4
            ...
            className='my-6 text-gray-700 font-Ovo'>Tools That I Use</motion.h4>
          <motion.ul
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            ...
            {toolsData.map((tool, index) => (
              <motion.li
                ...
                className='flex items-center justify-center w-12 duration-500 border border-gray-400 rounded-lg cursor-pointer sm:w-14 aspect-square hover:-translate-y-1' key={index} >
